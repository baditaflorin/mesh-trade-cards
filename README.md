...
**Live → https://baditaflorin.github.io/mesh-trade-cards/**

**Source → https://github.com/baditaflorin/mesh-trade-cards**
...
git clone https://github.com/baditaflorin/mesh-trade-cards
cd mesh-trade-cards
npm install
npm run dev
```
...
- `mesh-trade-cards:signalingUrl`
- `mesh-trade-cards:turnTokenUrl`
- `mesh-trade-cards:iceServers`
- `mesh-trade-cards:room`
